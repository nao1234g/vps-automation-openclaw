...
TARGETS = [
    ...
    "test_site_guard_scheduler",
    "test_prediction_maturity_audit",
...
def main() -> int:
    ...
    remote_cmd = " && ".join(
        [
            ...
            "python3 /opt/shared/scripts/test_site_guard_scheduler.py",
            "python3 /opt/shared/scripts/test_prediction_maturity_audit.py",
            ...
            "python3 /opt/shared/scripts/prediction_maturity_audit.py --base-url https://nowpattern.com --json-out /opt/shared/reports/site_guard/prediction_maturity_audit.json --md-out /opt/shared/reports/site_guard/prediction_maturity_audit.md",
